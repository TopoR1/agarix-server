...
Logger.info("\u001B[1m\u001B[32mMultiOgar-TopoR-Server " + gameServer.version + "\u001B[37m - An open source multi-protocol ogar server\u001B[0m");
...
gameServer.start();
figlet(('TopoR  v.  ' + gameServer.version), function(err, data) {
    if (err) {
